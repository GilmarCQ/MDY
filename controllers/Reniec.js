...
const getPerson = (req, res) => {
    ...
    // console.log(body);
    axios.get(`${URL_API_RENIEC}/Consultar?nuDniConsulta=${body.dniConsulta}&nuDniUsuario=${body.dniUsuario}&nuRucUsuario=${body.ruc}&password=${body.password}&out=${body.out}`)
    .then(response => {
        res.status(200).json({
            ok: true,
